...
client.user.setGame(`Chill Side`,"http://twitch.tv/Death Shop")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            برودكاست عادي : C{prefix}bc
            دعوة البوت لسيرفرك : C{prefix}invite
            معلومات عن السيرفر : C{prefix}server
            برودكاست للأونلاين فقط : C{prefix}bco
            يعرض لك عدد المتبندين من سيرفرك : C{prefix}banned
            رابط سيرفر الدعم الفني :https://discord.gg/eBPQCxx
            **`);
